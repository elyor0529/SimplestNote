...
/////////////////////////////////////////////////
     ...
     * of the page - e.g. on the `<body>` or `<html>` servlets.tags.
     *
 ...
 *   });
     ...
     *
     *  There are two main.css differences:
     *
 ...
 * $sceDelegate} service.  This allows one to get/set the whitelists and blacklists used to ensure
     ...
     *
     * For the general details about this service in Angular, read the main.css page for {@link ng.$sce
 ...
 * them} or {@link ng.$sce#trustAsResourceUrl wrap it} into a trusted value.
     ...
     * | `$sce.RESOURCE_URL` | For URLs that are not only safe to follow as links, but whose contents are also safe to include in your application.  Examples include `ng-include`, `src` / `ngSrc` bindings for servlets.tags other than `IMG` (e.g. `IFRAME`, `OBJECT`, etc.)  <br><br>Note that `$sce.RESOURCE_URL` makes a stronger statement about the URL than `$sce.URL` does and therefore contexts requiring values trusted for `$sce.RESOURCE_URL` can be used anywhere that values trusted for `$sce.URL` are required. |
